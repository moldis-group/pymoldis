...
#                 if zj == 6: bag_16.append(val)
#                 if zj == 7: bag_17.append(val)
#                 if zj == 8: bag_18.append(val)
#                 if zj == 9: bag_19.append(val)

#             if zi == 6: 
#                 if zj == 1: bag_16.append(val)
#                 if zj == 6: bag_66.append(val)
#                 if zj == 7: bag_67.append(val)
#                 if zj == 8: bag_68.append(val)
#                 if zj == 9: bag_69.append(val)

#             if zi == 7:
#                 if zj == 1: bag_17.append(val)
#                 if zj == 6: bag_67.append(val)
#                 if zj == 7: bag_77.append(val)
#                 if zj == 8: bag_78.append(val)
#                 if zj == 9: bag_79.append(val)

#             if zi == 8: 
#                 if zj == 1: bag_18.append(val)
#                 if zj == 6: bag_68.append(val)
#                 if zj == 7: bag_78.append(val)
#                 if zj == 8: bag_88.append(val)
#                 if zj == 9: bag_89.append(val)

#             if zi == 9:
#                 if zj == 1: bag_19.append(val)
#                 if zj == 6: bag_69.append(val)
#                 if zj == 7: bag_79.append(val)
#                 if zj == 8: bag_89.append(val)
#                 if zj == 9: bag_99.append(val)
...
#             if bob_N == 0: 
#                 desc_bag = bags[i] # BoB0
            
#             if bob_N == 1: 
#                 desc_bag = bags[i] + bags[indices[i][0]]  # BoB0+BoB1
            
#             if bob_N == 2: 
#                 if neighbour >= 2: 
#                     desc_bag = bags[i] + bags[indices[i][0]] + bags[indices[i][1]]  # BoB0+BoB1+BoB2 
#                 elif neighbour == 1:
#                     desc_bag = bags[i] + bags[indices[i][0]] + zero_bag
            
#             if bob_N == 3: 
#                 if neighbour >= 3: 
#                     desc_bag = bags[i] + bags[indices[i][0]] + bags[indices[i][1]] + bags[indices[i][2]] # BoB0+BoB1+BoB2+BoB3
#                 elif neighbour == 2:
#                     desc_bag = bags[i] + bags[indices[i][0]] + bags[indices[i][1]] + zero_bag
#                 elif neighbour == 1:
#                     desc_bag = bags[i] + bags[indices[i][0]] + zero_bag            + zero_bag
                
            
#             if bob_N == 4: 
#                 if neighbour >= 4: 
#                     desc_bag = bags[i] + bags[indices[i][0]] + bags[indices[i][1]] + bags[indices[i][2]] + bags[indices[i][3]]# BoB0+BoB1+BoB2+BoB3+BoB4
#                 elif neighbour == 3:
#                     desc_bag = bags[i] + bags[indices[i][0]] + bags[indices[i][1]] + bags[indices[i][2]] + zero_bag
#                 elif neighbour == 2:
#                     desc_bag = bags[i] + bags[indices[i][0]] + bags[indices[i][1]] + zero_bag            + zero_bag
#                 elif neighbour == 1:
#                     desc_bag = bags[i] + bags[indices[i][0]] + zero_bag            + zero_bag            + zero_bag
